...
public class InputActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("task0", String.valueOf(taskId));
        realm.close();
        ...
        if (mTask == null) {
            ...
            Log.d("task4", "new task");
            Log.d("task5", String.valueOf(taskId));
        } else {
            //更新の場合
    ...
    private void addTask() {
        ...
        if (mTask == null) {
            ...
            if (taskRealmResults.max("id") != null) {
                ...
                Log.d("task_MaxID",String.valueOf(taskRealmResults.max("id")));
                Log.d("task2", String.valueOf(identifier));
            } else {
                identifier = 0;
            }
